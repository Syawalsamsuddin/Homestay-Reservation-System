...
$r = mysqli_query($conn, "UPDATE  `booking` SET  `payment_status` =  'confirmed' WHERE  `booking`.`booking_id` = ".$id.";");
...
if(mysqli_num_rows($result) > 0)
	{
		...
		$bal = $row['total_amount']-$row['deposit'];
			...
			$message .="						<tr>\n";
			$message .="							<td><br>Questions? Email <a href=\"mailto:\">Uniselhomestay@gmail.com </a></td>\n";
			$message .="						</tr>\n";
			$message .="					</table>\n";
			$message .="				</div></div>\n";
			$message .="		</td>\n";
			...
			$headers  ="From: Uniselhomestay@gmail.com";
