					...
					while ($row = mysqli_fetch_array($result)) {
						if($row['availablehomestay'] != null && $row['availablehomestay'] > 0  )
						{
							...
							if(mysqli_num_rows($sub_result) > 0)
							{
								...
								print "										<select  class=\"no_of_homestay\" name=\"qtyhomestay\" id=\"homestay".$sub_row['homestay_id']."\" style=\"width:100%; color:black; height:45px;\" onchange=\"validateHomestay(this);\">\n";
							...
							if(mysqli_num_rows($sub_result2) > 0)
							{
								...
								print "								<div class=\"large-6 columns\">\n";
								print "									<label class=\"fontcolor\">\n";
								print "										<select  class=\"no_of_homestay\" name=\"qtyhomestay\" id=\"homestay".$sub_row2['homestay_id']."\" style=\"width:100%; color:black; height:45px;\" onchange=\"validateHomestay(this);\">\n";
								print "											<option selected=\"selected\" value=\"0\">0</option>\n";
																				$i = 1;
