...
<div class="row">
	<div class="large-4 columns blackblur fontcolor" style="margin-left:-10px; padding:10px;">
		...
		<p><b>Your Reservation</b></p><hr class="line">
				<form name="guestdetails" action="unsethomestaychosen.php" method="post" >
				<div class="row">
					<div class="large-12 columns">
						<div class="row">
						...
						<div class="row">
							<div class="large-6 columns" style="max-width:100%;">
								<span class="" ><?php 
													...
													foreach ($_SESSION['homestayname'] as &$value0 ) {
													echo $value0;
													print "<br>";
													} ;
				...
				<div class="row">					
						<div class="large-12 columns" style="max-width:100%;">
							<p class="fontgrey borderstyle" style="text-align:center;">10% Deposit Due Now<br>
	...
	<div class="large-8 columns blackblur fontcolor" style="padding:10px">
		...
		<p>
		<i class="icon-phone" style="font-size:24px"></i> <span class="i-name fontgrey">Phone</span><span class="i-code">&emsp; +601131130253</span><br>
        <i class="icon-fax" style="font-size:24px"></i> <span class="i-name fontgrey">Fax</span><span class="i-code"> &emsp;&emsp;+601131130253</span><br>
        <i class="icon-mail-alt"style="font-size:24px"> </i> <span class="i-name fontgrey">Email</span><span class="i-code">&emsp; UniselHomestay@gmail.com</span>
		</p><hr>
		<div class="row">
			<div class="large-12 columns" >
					...
					<input type="hidden" name="item_name" value="10% Homestay Deposit Payment for Booking ID #<?echo $_SESSION['booking_id'];?>">
					...
					<br><button class="button small " border="0" name="submit" alt="PayPal - The safer, easier way to pay online!" style="width:32%;background-color:#2ecc71; ">Pay Homestay Deposit Now</button>
