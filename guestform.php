				...
				$result = mysqli_query($conn, "select * from homestay");
					if(mysqli_num_rows($result) > 0){
						...
						while($row = mysqli_fetch_array($result)){
							...
							if (isset($_POST["qtyhomestay".$row['homestay_id'].""])   && !empty($_POST["qtyhomestay".$row['homestay_id'].""]) )
							{
								$_SESSION['homestay_id'][$count] = $_POST["selectedhomestay".$row['homestay_id'].""];
...
<div class="large-8 columns blackblur fontcolor" style="padding-top:10px;">
		...
		<form action="insertandemail.php" method="post"  onSubmit="return validateForm(this);">
		  ...
		  <div class="row">
			...
			<div class="large-6 columns">
			  <label class="fontcolor" !important;">Telephone Number*
